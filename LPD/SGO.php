    ...
    if (status == google.maps.DirectionsStatus.OK) {
	  ...
	  // Display the distance:
         ...
         document.getElementById('duration').innerHTML = 
            sumtime(time,secondsTimeSpanToHMS(response.routes[0].legs[0].duration.value));
...
function gps(latitude,longitude) {
	//alert(latitude);
	//alert(longitude);
	$('#latitud2').html(latitude);
	$('#longitud2').html(longitude);
	...
	var latA=$('#latitud').html();
	var longA=$('#longitud').html();
	var latB=latitude;
	var longB=longitude;
  ...
  $('#rotas').css("display","inherit");
  $('#distance').css("display","inherit");
  $('#duration').css("display","inherit");
  $('#distancia2').css("display","inherit");
  $('#duracao2').css("display","inherit");
  
  $('#rotas').click(function(){
   //window.location.href= "https://www.google.com/maps/dir/A/B/@"+latB+","+longB+",14z/data=!3m1!4b1!4m14!4m13!1m5!1m1!1s0x935a321a1333df03:0x3ba743f8a88ca99!2m2!1d"+latA+"!2d"+longA+"!1m5!1m1!1s0x935ef6bd58d80867:0xef692bad20d2678e!2m2!1d"+longB+"!2d"+latB+"!3e0";
   //window.location.href="https://www.google.com/maps/?q="+latB+","+longB; 
   window.location.href="http://www.google.com/maps/place/"+latB+","+longB;
  });
...
<body>
 ...
 <div class="paginaPrinc" id="paginaPrinc">
    <div style="display:none;"  id="latitud"></div>
    <div style="display:none;"  id="longitud"></div>
    <div style="display:none;" id="latitud2"></div>
    <div style="display:none;"   id="longitud2"></div>	
...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
   ...
   <!--<a href="objetos.php"><button type="button" class="btn btn-primary" style="margin:1%;">Ver todos os Anexos das ocorrências</button></a>-->
   <main role="main">
     <div style="display:none;margin-left:5%;" id="map-canvas"></div>
	 <div class="row" style="margin-left:8%;margint-top:12%;">
	 <div id="distancia2" class="col btn btn-success" style="display:none;font-size:18px;">Distância : <span id="distance" /></div>
	 <div id="duracao2"  style="font-size:18px;display:none;" class="col btn btn-warning">Previsão de chegada : <span id="duration" /></div>
	 <div  style="display:none;font-size:18px;font-family:helvetica;" id="rotas" class="col btn btn-primary">
 <span style="margin-left:40%;">Ir até o local</span></div>
     </div>
	 ...
	 <th id="comandante">COMANDANTE</th>
	 <th id="natureza">NATUREZA</th>
	 ...
	 <th id="endereco" >LAT</th>
	 <th id="endereco" >LNG</th>
	 <th id="endereco" >MAPS</th>
	 <th id="historico_inicial">HISTÓRICO INICIAL</th>
	 <th></th>
     </thead>
	 </table>
	     </main>
...
var r=confirm("Deseja remover essa ocorrência?");
	   ...
	   $('#tt1_3').css("display","none");
	    $('#tt2_1').css("display","none");
		 $('#tt2_2').css("display","none");
		  $('#tt2_3').css("display","none");
		  $('#alerta_sem_imagem').css("display","none");
	$.getJSON("getBaixados.php?numero="+id, function (data) {
		for(i=0;i<data.data.length;i++)
		{
			...
			$('#contato2').html(data.data[0].contato);
            ...
            },	
{
	...
	if(isMobile)
	{
		...
		// table.column( 10 ).visible( false );
	     ...
	     $('#example').css("width","400px");
		 $('#baixo').css("width","400px");
	}
	else{
...
<div id="tabs" style="display:none;"  >
	<ul>
		<li><a href="#aba-1">Ocorrência</a></li>
...
$(document).ready(function(){
     $('#tipo').change(function(){
		 $('#identificacao_titulo').html('Identificação');
		 $('#marca_titulo').html('Marca');
		 $('#caracteristicas_titulo').html('caracteristicas');
		 
		 if($("#tipo option:selected").text()=="Veículo automotor")
		 {	 $('#identificacao_titulo').html('Placa');}
	 	 if($("#tipo option:selected").text()=="Animal doméstico")
		 {	 $('#marca_titulo').html('Espécie');}
	 	 if($("#tipo option:selected").text()=="Animal Silvestre")
		 {	 $('#marca_titulo').html('Espécie');}	
	 	 if($("#tipo option:selected").text()=="Pessoa")
		 {	 $('#marca_titulo').html('Nome');}	 	 
	 });
