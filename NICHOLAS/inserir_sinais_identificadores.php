 ...
 data:valor,
  success: function(data){
	...
	window.location.href="index.php";
		...
		alert("Você tem que cadastrar pelo menos uma foto do veículo");
	}
   },
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="col-12 pt-3 pb-3">
        ...
        <div id="page-content" class="row pb-3 d-print-block">
		   ...
		   <h5>Marca</h5><select type="text" class="form-control" id="marca" ><option></option><option>Toyota</option><option>Volkswagen</option><option>Ford</option> <option>Honda</option><option>Hyundai</option><option>Nissan</option><option>Chevrolet</option><option>Kia</option><option>Mercedes-Benz</option><option>BMW</option><option>Renault</option><option>Fiat</option></select>
		   <h5>Modelo</h5><input type="text" class="form-control" id="modelo" placeholder="Fiesta/Uno/Sandero"></input>
		   <h5>Ano</h5><input type="text" class="form-control" id="ano" placeholder="2000/2005/2010"></input>
