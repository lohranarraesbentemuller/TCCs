...
$(document).ready(function(){
	 ...
	 $('#enviar').click(function(){
		valor="chassi="+$('#chassi').val();

		valor+="&marca="+$('#marca option:selected').text();

	 $.ajax({ 
 type:"POST", 
  url: "pesquisar_sinais.php",
 data:valor,
  success: function(data){
   //  alert(valor);
     ...
     var s="";
     s+='<table class="table">';
      s+='<thead class="thead-dark" style="background-color:#0f6fc5 !important;">';
      s+='<tr>';
      s+='<th scope="col" style="background-color:#0f6fc5 !important;">Caracter</th>';
      s+='<th scope="col" style="background-color:#0f6fc5 !important;">Significado</th>';
      s+='<th scope="col" style="background-color:#0f6fc5 !important;">Marca</th>';
      s+='<th scope="col" style="background-color:#0f6fc5 !important;">Posição do caracter</th>';
      s+='</tr>';
      s+='</thead>';
      s+='<tbody>';
     for(i=0;i<data.split("@").length-1;i++){
         cc=data.split("@")[i];
      //   alert(cc);
         caracter=cc.split("Caracter:")[1].split("#")[0];
         significado=cc.split("Significado:")[1].split("#")[0];
         marca=cc.split("Marca:")[1].split("#")[0];
         posicao=cc.split("Posição do caracter:")[1].split("#")[0];
         s+='<tr><td>'+caracter+'</td>';
         s+='<td>'+significado+'</td>';
         s+='<td>'+marca+'</td>';
         s+='<td>'+posicao+'</td>';
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="col-12 pt-3 pb-3">
		...
		<h5>Marca</h5><select type="text" class="form-control" id="marca" ><option></option>
		 <?php
        $sql="select * from c1 group by marca";
        $result=mysqli_query($db,$sql);
		...
		<h5>Chassi</h5><input type="text" class="form-control" id="chassi" value=""></input>

		<h5 style="margin-top:1%;" id="resultado">Resultado</h5>
		...
		<button class="btn btn-primary" id="enviar">Pesquisar</button>
