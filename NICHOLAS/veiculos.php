...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="col-12 pt-3 pb-3">
        ...
        <div id="page-content" class="row pb-3 d-print-block">
		   ...
		   <!-- colocar aqui -->
		<?php
		$sql="select * from veiculos left join imagens on veiculos.id=imagens.id_veiculo where principal='sim'";
		...
		$terceiro=false;	
			...
			echo "<div class='col'>";
			echo "<a href='veiculo.php?id=".$row['id_veiculo']."'>";
			echo "<img style='width:350px;height:350px;' src='./upload/".$row['id_veiculo']."/".$row['caminho']."'></img>";
			echo "<h6>".$row['marca']." - ".$row['modelo']." ".$row['ano']."</h6>";
			echo "</a>";
			echo "</div>";
