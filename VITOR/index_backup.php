...
<table align="center" cellspacing="0" style="border-collapse:collapse; width:641px">
	<tbody>
		<tr>
			...
			<p id="brasoes"><img src="./PMDF-brasoesPNG/61_brasao_APMB.png" style="height:108px; width:92px" /></p>
			</td>
			...
			<p id="UPM">ACADEMIA DE POL&Iacute;CIA MILITAR DE BRAS&Iacute;LIA</p>
			</td>
			...
			<p id="cmt_1">_________________________ WILLIAN DELANO MARQUES DE ARA&Uacute;JO</p>

			<p  id="cmt_2">CEL &ndash; Cmt da APMB</p>
			</td>
		</tr>
		<tr>
			...
			<p id="os">ORDEM DE SERVI&Ccedil;O N&ordm; 00000/P-3</p>
			</td>
		</tr>
		<tr>
			...
			<p id="enderecado">Ao(s):SUPERVISOR/SVG</p>
			</td>
		...
		<tr>
			...
			<p id="referencia">Refer&ecirc;ncia: SEI n&ordm; 00000-0000000/2021-48.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
			</td>
			...
			<p id="evento">Evento: Passeio cicl&iacute;stico</p>
			</td>
		</tr>
		<tr>
			<td colspan="2" style="border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; height:19px; vertical-align:top; width:279px">
			<p id="data">Data:06/05/2021 a 08/06/2021</p>
			</td>
			<td colspan="2" style="border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; height:19px; vertical-align:top; width:361px">
			<p id="horario">Hor&aacute;rio:15:00 as 21:00 horas</p>
			</td>
		</tr>
		<tr>
			<td colspan="4" style="border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; height:19px; vertical-align:top; width:641px">
			<p id="local">Local: Estacionamento 13 do parque da cidade</p>
			</td>
		</tr>
		<tr>
			<td colspan="4" style="border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; height:19px; vertical-align:top; width:641px">
			<p id="TSE">TSE: (&nbsp; ) sim&nbsp;&nbsp;&nbsp; (X) n&atilde;o</p>
			</td>
		</tr>
		<tr>
			<td colspan="4" style="border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; height:19px; vertical-align:top; width:641px">
			<p id="efetivo">Efetivo: 02 policiais com moto e 02 policiais POG</p>
			</td>
		</tr>
		<tr>
			<td colspan="2" style="border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; height:19px; vertical-align:top; width:279px">
			<p id="duracao">Dura&ccedil;&atilde;o: 07 horas</p>
			</td>
			<td colspan="2" style="border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; height:19px; vertical-align:top; width:361px">
			<p id="uniforme">Uniforme: 6a</p>
			</td>
		</tr>
		<tr>
			<td colspan="2" style="border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; height:19px; vertical-align:top; width:279px">
			<p id="equipamento">Equipamento: tonfa , espargidor</p>
			</td>
			<td colspan="2" style="border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; height:19px; vertical-align:top; width:361px">
			<p id="armamento">Armamento: PT .40 24/7 PRO DS , 3 carregadores</p>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<p id="missao">Miss&atilde;o do Policiamento: Realizar patrulhamento para assegurar a integridade do patrim&ocirc;nio p&uacute;blico e privado, com especial aten&ccedil;&atilde;o &agrave;s &aacute;reas isoladas do parque, sobretudo no per&iacute;odo noturno</p>
			</td>
		</tr>
		<tr>
			...
			<p>Prescri&ccedil;&otilde;es diversas:</p>

			<ol>
				<li>O mais antigo dever&aacute; fazer contato com o SUPERVISOR DA &Aacute;REA para informar a presen&ccedil;a do Policiamento;</li>
				<li>Em caso de ocorr&ecirc;ncia de vulto, que gere repercuss&atilde;o ou envolva policiais militares ou outras autoridades, dever&aacute; comunicar de imediato ao adjunto que imediatamente deve informar ao supervisor</li>
				<li>RF de 1 hora, alternando entre as equipes.</li>
			</ol>
		...
		<tr>
			...
			<p id="local_data">Bras&iacute;lia, 06 &nbsp;de Maio &nbsp;de 2021.</p>

			<p>__________________________________________</p>

			<p id="nome_posto">NOME &ndash; POSTO</p>

			<p id="chefe">Chefe da 3&ordf; Se&ccedil;&atilde;o</p>
...
$(document).ready(function(){
	 ...
	 $('#enviar_tabela').click(function(){
		 ...
		 var data=$("#data").html().split("Data:")[1].split(" a ")[0];
		 ...
		 //teste
         valor+="&cmt1="+$('#cmt1').html();
		 valor+="&cmt2="+$('#cmt2').html();
