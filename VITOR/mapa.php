...
$(document).ready(function(){
	var fa_plus=0;
	$(document).find(".fa-plus").each(function(){
		fa_plus++;
	});
	...
	$('#salvar').click(function(){
		$('.titulo').each(function(){
			...
			$("."+id).each(function(){
				...
				linha+=titulo2+";"+$(this).find("td").eq(0).find("p").html()+"|"+$(this).find("td").eq(1).find("p").html()+"|"+$(this).find("td").eq(2).find("p").html()+"|"+$(this).find("td").eq(3).find("p").html()+"|"+$(this).find("td").eq(4).find("p").html()+"|"+$(this).find("td").eq(5).find("p").html()+"|"+$(this).find("td").eq(6).find("p").html()+"|"+"@";
				//alert(horario);
			});
		});
		valor="titulo="+titulo;
...
//teste		  
	  ...
	  $(document).arrive('.fa-plus',function(){
	$('.fa-plus').click(function(){
		//alert($(this).parent().parent().parent().parent().attr("id"));
		var id=($(this).parent().parent().parent().parent().attr("id"));
		var contador2=1;
