		...
		<div class="card">
			...
			<div class="card-body">
				<form method="POST">
					<div class="input-group form-group">
						...
						<input id="nome" name="nome" type="text" class="form-control" placeholder="usuário" autocomplete="off">
			...
			<div class="card-footer">
				<div class="d-flex justify-content-center links">
					Não possui acesso?<a href="https://wa.me/5561981997618">Solicite um cadastro</a>
				</div>
