		 ...
		 "columnDefs": [
            ...
            },
            {
				...
				var q=0;
                   ...
                   // return s.replace("&Ccedil;","ç");
					return '<table style="border:none;" ><tr style="border:none;"><td style="border:none;">'+s+row['endereco'].substring((s.length-q),row['endereco'].length)+'</td><td style="border:none;"><a href="'+row['maps']+'" target="_blank"><img class="gps" src="gps.png" style="width:25px;height:25px;"/></a></td></tr></table>' ;
                },
                "targets": 9
            },		
            {
...
<div id="tabs" style="display:none;"  >
  ...
  Objeto anexado à ocorrência, use o formulário abaixo para inserir imagens para esse objeto
		...
		<h6 id="marca_titulo">Marca</h6>
		<input id="marca" type="text" class="form-control"></input>
		<h6 id="identificacao_titulo">Identificacao</h6>
		<input id="identificacao" type="text" class="form-control"></input>
		<h6 id="caracteristicas_titulo">Características</h6>
