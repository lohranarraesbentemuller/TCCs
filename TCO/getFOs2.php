...
$columns = array(
    ...
    array( 'db' => 'ocorrencia_id','dt'=>'ocorrencia_id'),
...
$table = <<<EOT
 (
 select t1.*,t2.numero from (select * from objetos_rocha_soares)t1 inner join(select * from exemplo_rocha_soares)t2 on t1.ocorrencia_id=t2.id
 ) temp
EOT;
...
{
$where="ocorrencia_id= ".$_GET['numero']." ";
}
else
{
	$where="1=1";
