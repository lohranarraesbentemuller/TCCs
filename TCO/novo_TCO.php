...
$sql="insert into TCO(contador,tipo_penal,fonte,descricao,tags,cabe_tco,ncabe_tco,atencao) values(".$_GET['id'].",'".$_POST['tipo_penal']."','".$_POST['fonte']. "','".htmlspecialchars($_POST['descricao'])."','".$_POST['tags_reais']."','".htmlspecialchars($_POST['cabe_tco'])."','".htmlspecialchars($_POST['ncabe_tco'])."','".htmlspecialchars($_POST['atencao'])."')";
...
?>
 ...
 <button type="button" id = "x2" class="btn btn-warning">
            X
        </button>
  ...
  <tbody>
    ...
    <div class="row">
	 ...
	 $row=mysqli_fetch_array($result,MYSQLI_ASSOC);
	 ?>
	 <input type="text" name="tipo_penal" class="form-control genesis" autocomplete="off" value="<?php echo $row['tipo_penal'];?>"/>
	 </div></div>
	 <div class="row">
	 <div class="col">
	 ...
	 <input type="text"  name="fonte" class="form-control genesis data" autocomplete="off" value="<?php echo $row['fonte'];?>"/>
	 </div>
	 </div>
	 </div>
	 <div class="row">
	 <div class="col">
	 <div  style="display:none;" id="alerta_descricao" class="alert alert-danger" role="alert">Preencha a descrição</div>
	 <span class="hidden-sm hidden-md"><h4><span class="fa fa-file-text"></span> Descrição</h4></span>
	 <div class="form-group">
	 <textarea   id="descricao" name="descricao" class="form-control genesis" autocomplete="off"><?php echo $row['descricao'];?></textarea>
	 </div>
	 </div>	 </div>
	 <div class="row">
	 <div class="col">
	 ...
	 <input type="text"  id ="tags" name="tags" class="form-control genesis" autocomplete="off" value="<?php echo $row['tags'];?>"/>
	 ...
	 <textarea  name="cabe_tco" id="cabe_tco" class="form-control genesis" ><?php echo $row['cabe_tco'];?></textarea>
	 </div>
   	</div>
    ...
    <div class="row">
     ...
     <span class="hidden-sm hidden-md"><h4><span class="fa fa-times"></span> Caso que não cabe TCO</h4></span>
	 <textarea  name="ncabe_tco" id="ncabe_tco" class="form-control genesis"><?php echo $row['ncabe_tco'];?></textarea>
     </div>
	 </div>
	 <div class="row">
	 <div class="col">
	 <div id="alerta_atencao" style="display:none;" class="alert alert-danger" role="alert">Preencha o campo de atenção</div>
	 <span class="hidden-sm hidden-md"><h4><span class="fa fa-exclamation-triangle"></span> Ponto de Atenção!</h4></span>
	 <textarea   name="atencao" id="atencao" class="form-control genesis"><?php echo $row['atencao'];?></textarea>
	 </div>
	 </div>
	 ...
	 <div class="col"></div>
     <div class="col">
       <button class="btn btn-primary"  style="margin-top:10%;" >Gerar</button>
	  </div>
   </div>
	</form>
